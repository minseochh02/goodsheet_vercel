...
export default async function KakaoAdd({
	params,
}: {
	...
	// TODO: Fetch user_name from API or database
	...
	const { data: app } = await supabase
		...
		.eq("id", user_id)
		.single();
	const user_name = app?.kakao?.nickname;
	const profile_pic = app?.kakao?.profile_image;
